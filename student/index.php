...
include('../connection.php');
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $myusername = mysqli_real_escape_string($db,$_POST['clgid']);
      $mypassword = mysqli_real_escape_string($db,$_POST['pass']); 
      
      $sql = "SELECT studentid FROM studentdata1 WHERE  clgid = '$myusername' and password = '$mypassword'";
                     ...
                     <div class="panel-heading">
                        LOGIN
                          ...
                          <div class="panel-body">
                            ...
                            <input type="text" name="clgid"   placeholder=" type your rollno " class="form-control">
</div>
                    <div class="form-group">
